...
<br/><br/>If there are any available opportunities or if anyone could provide guidance or mentorship, I would greatly appreciate it. I am looking forward to connecting with all of you and being part of the web development community.
                </p>
             </div>
          </div>

          <img className='mx-auto my-auto rounded-3xl py-8 md:py-0' src={aboutImg} width={300} height={300}/>
